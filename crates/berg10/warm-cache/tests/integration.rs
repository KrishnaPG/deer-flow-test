...
fn warm_cache_config_paths() {
    ...
    assert_eq!(config.checkout_path("music-by-year"), "/tmp/berg10-test/checkouts/music-by-year");
    assert_eq!(config.content_path("abc123"), "/tmp/berg10-test/content/abc123");
}
