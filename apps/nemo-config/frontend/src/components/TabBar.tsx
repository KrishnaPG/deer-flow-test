...
import type { ServiceStatus } from '../definitions';
    ...
    <div className="flex border-b border-gray-200 bg-gray-100 overflow-x-auto">
      {tabs.map(tab => (
        <div
          ...
          className={`group flex items-center gap-2 px-4 py-2 cursor-pointer border-r border-gray-200 text-sm min-w-fit ${activeTabId === tab.id
