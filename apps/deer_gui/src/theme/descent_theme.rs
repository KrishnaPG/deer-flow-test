//! Descent theme — deep blue-grey atmosphere with warm amber accents.
//!
//! Evokes the feeling of a drop-ship observation deck descending through
//! alien clouds. Cool blues and greys dominate, punctuated by warm amber
//! colony beacons and cyan-teal particle trails.
